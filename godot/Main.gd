...
func _ready():
	...
	make_label(menu, "Renderer: OpenGL compatibility\nIf you see this, the black screen is fixed.", Vector2(55, 175), 22)
...
func finish_boot():
	print("Backrooms boot: UI is visible")
...
func start_game():
	...
	menu.visible = false
	status.visible = true
	status.text = "Level 0 loaded. Touch controls and gameplay will appear after the next gameplay pass."
